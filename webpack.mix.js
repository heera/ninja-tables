...
mix.js('src/admin/main.js', `assets/js/ninja-tables-admin.js`)
    ...
    .sass('src/admin/css/vendor.scss', 'assets/css/ninja-tables-vendor-ltr.css')
    .sourceMaps(true);

mix.then(() => {
    exec('rtlcss ./assets/css/ninja-tables-vendor-ltr.css ./assets/css/ninja-tables-vendor-rtl.css', (error, stdout, stderr) => {
        if (error) {
